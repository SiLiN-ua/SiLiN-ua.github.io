...
(function(){
  var DICT = {
    uk: {
      ...
      'chinese wall':      'Chinese Wall — інформаційний барʼєр між відділами в банку/фінустанові. Приклад: команда, що знає про майбутню угоду, фізично і юридично ізольована від тих, хто торгує на біржі, — щоб внутрішнє знання не пішло у торгівлю.',
      'insider trading':   'Торгівля акціями на основі внутрішньої інформації, недоступної публіці (планована угода, звіт, зміна керівництва). Кримінальний злочин у США й ЄС.',
      'material non-public information':'Внутрішня інформація компанії, яка не публікувалася і здатна суттєво зрушити ціну її акцій (напр. заплановане поглинання). Торгівля на ній = злочин.',
      'mnpi':              'MNPI (Material Non-Public Information) — внутрішня інформація компанії, здатна зрушити ціну акцій. Торгівля на ній = кримінал.',
    ...
    en: {
      ...
      'chinese wall':      'Chinese Wall — informational barrier between departments in a bank/finance firm. Example: a team that knows about an upcoming deal is physically and legally isolated from the traders, so internal knowledge cannot leak into trading.',
      'insider trading':   'Trading shares based on internal information unavailable to the public (planned deal, unreleased earnings, leadership change). Criminal in the US and EU.',
      'material non-public information':'Company-internal information, not published, capable of significantly moving its share price (e.g. a planned acquisition). Trading on it = criminal.',
      'mnpi':              'MNPI (Material Non-Public Information) — company-internal information capable of moving the share price. Trading on it = criminal.',
