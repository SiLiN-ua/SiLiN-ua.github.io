...
**Живий сайт:** `https://yehor-selin.github.io/` *(після деплою)*
**Адмінка:** `https://yehor-selin.github.io/admin/`
...
- Створи публічний репо `yehor-selin.github.io` в акаунті **SiLiN-ua** (назва повинна збігатися з `<login>.github.io`).
...
git remote add origin https://github.com/SiLiN-ua/yehor-selin.github.io.git
git push -u origin main
```

- Settings → Pages → Source → **Deploy from a branch → main / (root)**.
- Через 1-2 хв сайт живий на `https://yehor-selin.github.io/`.
...
2. Заповни:
   ...
   - **Homepage URL:** `https://yehor-selin.github.io/`
   - **Authorization callback URL:** `https://yehor-selin.github.io/admin/`
...
- Йди на `https://yehor-selin.github.io/admin/`.
...
2. У DNS-провайдера додай A-записи на: `185.199.108.153`, `185.199.109.153`, `185.199.110.153`, `185.199.111.153` (GitHub Pages IPs), плюс CNAME `www` → `yehor-selin.github.io`.
...
**Після деплою:**
- Google Search Console → додай властивість `https://yehor-selin.github.io/` → submit `sitemap.xml`.
